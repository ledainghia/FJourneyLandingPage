export default function Content2_5() {
    return (
        <>
                    ...
                    <div className="row d-flex align-items-center">
                        <div className="col-md-6">
                            <div className="img-block wow fadeInUp" data-wow-delay="0.3s">
                                <img className="img-fluid" src="/images/about-img.png" alt="content-image" />
                            </div>
                        </div>
                        <div className="col-md-6">
                            <div className="txt-block pc-30 wow fadeInUp" data-wow-delay="0.1s">
                                <span className="section-id primary-color">About ShiftKey</span>
                                <h3 className="h3-md">We are making design better for everyoney</h3>
