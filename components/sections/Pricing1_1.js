export default function Pricing1_1() {
    return (
        <>
            <section id="pricing-1" className="bg-lightgrey grey-textured wide-60 pricing-section">
                <div className="container">
                    <div className="row">
                        <div className="col-lg-10 offset-lg-1 section-title">
                            <h3 className="h3-md steelblue-color">Simple Pricing, Instant Sign Up</h3>
                    ...
                    <div className="row d-flex align-items-center pricing-row primary-theme">
                        ...
                        <div className="col-md-4">
                            <div className="pricing-table highlight wow fadeInUp" data-wow-delay="0.7s">
                                ...
                                <a href="#" className="btn btn-primary-color tra-black-hover">Select Plan</a>
                            </div>
                        </div>
                        <div className="col-md-4">
                    ...
                    <div className="row">
                        <div className="col-lg-8 offset-lg-2 wow fadeInUp" data-wow-delay="1s">
                            <div className="pricing-notice mb-40 text-center">
                                <p className="p-md steelblue-color"><span>Note!</span> Prices may vary from location to location due to local
