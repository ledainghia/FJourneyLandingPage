export default function Content2_10() {
    return (
        <>
                    ...
                    <div className="row d-flex align-items-center">
                        ...
                        <div className="col-md-6">
                            <div className="txt-block pc-30 wow fadeInUp" data-wow-delay="0.1s">
                                ...
                                <h3 className="h3-md steelblue-color">Enhance your website design with ShiftKey</h3>
                                ...
                                <h5 className="h5-md steelblue-color">Features Never Stop</h5>
