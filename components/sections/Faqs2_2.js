export default function Faqs2_2() {
    return (
        <>
            <section id="faqs-2" className="bg-lightgrey wide-100 faqs-section division">
                <div className="container">
                    <div className="row">
                        <div className="col-lg-10 offset-lg-1 section-title">
                            <h3 className="h3-md steelblue-color">Frequently Asked Questions</h3>
                    ...
                    <div className="row">
                        <div className="col-lg-6">
                            <div className="questions-holder">
                                <div className="question wow fadeInUp" data-wow-delay="0.1s">
                                    <h5 className="h5-xs steelblue-color">Do you have non-profit discount?</h5>
                                ...
                                <div className="question wow fadeInUp" data-wow-delay="0.3s">
                                    <h5 className="h5-xs steelblue-color">Do you have a free trial?</h5>
                                ...
                                <div className="question wow fadeInUp" data-wow-delay="0.8s">
                                    <h5 className="h5-xs steelblue-color">How do I install a ShiftKey?</h5>
                        ...
                        <div className="col-lg-6">
                            <div className="questions-holder ind-30">
                                <div className="question wow fadeInUp" data-wow-delay="0.1s">
                                    <h5 className="h5-xs steelblue-color">What I can do with my purchase?</h5>
                                    <ul className="content-list mb-35">
                                ...
                                <div className="question wow fadeInUp" data-wow-delay="0.3s">
                                    <h5 className="h5-xs steelblue-color">How can I update or cancel my personal information?</h5>
                                ...
                                <div className="question wow fadeInUp" data-wow-delay="0.8s">
                                    <h5 className="h5-xs steelblue-color">I have technical problem, who do I email?</h5>
                                    <p>Feugiat eros, ac tincidunt ligula massa in faucibus orci luctus et ultrices posuere
                    ...
                    <div className="row">
                        <div className="col-md-12 text-center">
                            <div className="more-questions wow fadeInUp" data-wow-delay="1.2s">
                                <h5 className="h5-xs steelblue-color">Still have a question? <a href="#/faqs">Ask your question here</a></h5>
                            </div>
                        </div>
                    </div>
                </div>
