...
export default function Contacts2_3() {
    return (
        <>
            <section id="contacts-2" className="bg-lightgrey wide-80 contacts-section division">
                <div className="container white-color1">
                    <div className="row">
                            ...
                            <div className="form-holder text-center">
                                <form name="registerform" className="row register-form">
                                    ...
                                    <div className="col-lg-12 form-btn text-right">
                                        <button type="submit" className="btn btn-lg submit btn-primary-color black-hover">Start Your Free Trial</button>
                                    </div>
