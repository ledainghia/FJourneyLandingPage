export default function Content2_2() {
    return (
        <>
            <section id="content-2" className="blue-textured wide-60 content-section division">
                    ...
                    <div className="row d-flex align-items-center">
                        ...
                        <div className="col-md-6">
                            <div className="txt-block pc-30 wow fadeInUp" data-wow-delay="0.1s">
                                <span className="section-id white-color">Handling With Ease</span>
