...
export default function Statistic2_2() {
    return (
        <>
            <div id="statistic-2" className="bg-primary-color grey-textured statistic-section division">
                    ...
                    <div className="row">
                        ...
                        <div className="col-sm-6 col-md-3">
                            <div className="statistic-block icon-xs wow fadeInUp" data-wow-delay="0.3s">
                                ...
                                <h5 className="statistic-number">5,<CounterUp end={281} /></h5>
                        ...
                        <div className="col-sm-6 col-md-3">
                            <div className="statistic-block icon-xs wow fadeInUp" data-wow-delay="0.8s">
                                ...
                                <h5 className="statistic-number">6,<CounterUp end={179} /></h5>
                        ...
                        <div className="col-sm-6 col-md-3">
                            <div className="statistic-block icon-xs wow fadeInUp" data-wow-delay="1s">
                                ...
                                <h5 className="statistic-number">1,<CounterUp end={473} /></h5>
